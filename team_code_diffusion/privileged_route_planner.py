...
class PrivilegedRoutePlanner(object):
    ...
    def run_step(self, agent_position):
        ...
        return (self.route_points[self.route_index+5], self.route_points[self.route_index:self.route_index+10],
    ...
    def compute_speed_limits(self, carla_map):
        ...
        file_name_speed_limits = os.path.join(os.environ.get("WORK_DIR", "."), f"team_code/speed_limits/{map_name}_speed_limits.npy")
